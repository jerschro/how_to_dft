[:fontawesome-solid-house:](../index.md) :fontawesome-solid-angle-right: [ME 5329](index.md) :fontawesome-solid-angle-right: **Homework 1**

# Homework 1

![Homework_1_Instructions.pdf](../assets/pdfs/me_5329/Homework_1_Instructions.pdf){ type=application/pdf style="min-height:100vh;width:100%" }

## create_ir_spectrum.py

```python title="create_ir_spectrum.py"
import os
import numpy as np
