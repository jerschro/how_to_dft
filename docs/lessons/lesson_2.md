[:fontawesome-solid-house:](../index.md) :fontawesome-solid-angle-right: [Lessons](index.md) :fontawesome-solid-angle-right: **Lesson 2**
...
=== ".zmat file"
    ...
    Watch this [TMP Chem Video](https://youtu.be/-RDRp7Kqgmk?si=SQj3kWxub8j4gqNM) to learn more.
    ...
    You can find this file and other files in the github repository [tmpchem/computational_chemistry/geom/zmat](https://github.com/tmpchem/computational_chemistry/tree/14964a0cc6ded3856650285b5cc79396f94a7693/geom/zmat)

## How to Generate a Molecule from SMILES

Below is python code utilizing the [RDKit](https://www.rdkit.org/docs/api-docs.html) library to generate a molecule from a SMILES string. Replace the 'smile_string' variable with the SMILES of your choice and you can replace 'xyz_filename' with the xyz filename of your choice.
